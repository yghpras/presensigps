...
<div class="section" id="user-section">
    ...
    <div id="user-detail">
        <div class="avatar">
            ...
            @else
                <img src="assets/img/sample/avatar/avatar1.jpg" alt="avatar" class="imaged w64 rounded" style="height: 60px">
            @endif
        </div>
        <div id="user-info">
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding:  12px 12px !important; line-height: 0.8rem">
                        <span class="badge bg-danger" style="position: absolute; top: 3px; right: 50px; font-size: 0.6rem;
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding:  12px 12px !important; line-height: 0.8rem;">
                        ...
                        <ion-icon name="reader-outline" style="font-size: 1.6rem"class= "text-warning mb-1"></ion-icon>
                        <br>
