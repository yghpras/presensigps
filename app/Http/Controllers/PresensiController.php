...
class PresensiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($radius > $lok_kantor->radius) {
            echo "error|Maaf anda berada diluar Radius, jarak anda ".$radius."Meter dari Hotel|radius";
        } else {
            if ($cek > 0){
                $data_pulang = [
                    'jam_out' => $jam,
                ...
                if ($update){
                    echo "susccess|Terimakasih, Hati hati di jalan|out";
                ...
                $simpan = DB::table('presensi')->insert($data);
                if ($simpan){
                    echo "susccess|Terimakasih, Selamat Bekerja|in";
                    Storage::put($file, $image_base64);
                } else {
    ...
    public function gethistori(Request $requets)
    {
        $bulan = $requets->bulan;
        $tahun = $requets->tahun;
        $nik = Auth::guard('karyawan')->user()->nik;
    ...
    public function cetakrekap(Request $request)
    {
        ...
        $rekap = DB::table('presensi')
                ...
                if (isset($_POST["exportexcel"])) {
                    ...
                    header("Content-type: application/vnd-ms-excel");
                    // Mendefinisikan nama file ekspor "hasil-export.xls"
                    header("Content-Disposition: attachment; filename=Reakp Presensi Karyawan $time.xls");
                }
